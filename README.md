...
* [YARP](https://github.com/microsoft/reverse-proxy) ⭐ 9,609 | 🐛 191 | 🌐 C# | 📅 2026-08-31 - YARP (which stands for "YARP: A Reverse Proxy") is a toolkit for developing high-performance HTTP reverse proxy applications
* [Ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,714 | 🐛 57 | 🌐 C# | 📅 2026-09-03 - .NET core API Gateway

### Service Discovery

* [Consul.NET](https://github.com/G-Research/consuldotnet) ⭐ 372 | 🐛 3 | 🌐 C# | 📅 2026-09-03 - Consul.NET is a .NET client library for the [HashiCorp Consul](https://github.com/hashicorp/consul) ⭐ 30,059 | 🐛 1,422 | 🌐 Go | 📅 2026-09-05 HTTP API

### Frameworks

* [Foundatio](https://github.com/FoundatioFx/Foundatio) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-06 - Pluggable foundation blocks for building distributed apps.
...
* [Dapr](https://github.com/dapr/dotnet-sdk) ⭐ 1,202 | 🐛 212 | 🌐 C# | 📅 2026-09-01 - Dapr SDK for .NET ([Dapr](https://github.com/dapr/dapr) ⭐ 26,081 | 🐛 452 | 🌐 Go | 📅 2026-09-04 is a portable, event-driven, serverless runtime for building distributed applications)
